/**
 * generateLayout.js — CLIENT copy (ESM)
 * Place in: client/src/generateLayout.js
 * Identical logic to server copy — only export syntax differs.
 */
